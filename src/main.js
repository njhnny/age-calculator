...
$(document).ready(function() {
  $("form#form").submit(function(event) {
    ...
    $("p").append(`Your time left on Venus is ${venusRemain} Venus years`);
    $("p").append(`Your time left on Mars is ${marsRemain} Mars years`);
    $("p").append(`Your time left on Mars is ${jupiterRemain} Mars years`);
    $("p").append(`Your time left on Mars is ${saturnRemain} Mars years`);
